          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 pb-8">
              <div className="py-4 px-2 bg-[#f4f4f4] dark:bg-[#222222] rounded-2xl grid grid-cols-1 xl:grid-cols-2 gap-2">
                ...
                >
                  <span className="text-xl font-medium px-2">{event.city}</span>
            ...
            <div className="page-content">
              ...
              <ul className="list-disc flex flex-col gap-y-2 text-light-txt dark:text-dark-txt text-opacity-60 dark:text-opacity-60 list-inside">
                <li>
                  After the event begins, EventPassify and the Organizer are not
                  responsible for attendees being unable to sit in their
                  purchased seats. The Organizer company and EventPassify do not
                  guarantee seating for latecomers. Therefore, we kindly request
                  that you arrive well before the concert time.
                </li>
                <li>
                  Children under 6 years old are not allowed in the event area.
                  Attendees aged 6 and above must have a valid ticket.
                </li>
                <li>
                ...
                <li>
                  ...
                  will not be allowed to re-enter using the same ticket. Guests
                  wishing to re-enter must purchase a new ticket.
                </li>
                <li>
                ...
                <li>
                  Event tickets must be obtained only from officially designated
                  sales points determined by the event organizer. The event
                  organizer has the right to deny entry to the event area for
                  tickets not purchased from official sales points.
                </li>
                <li>
                  Purchased tickets cannot be used for commercial or
                  non-commercial purposes such as advertising, contests,
                  raffles, promotions, etc., without written permission from the
                  Organizer. Tickets used for such purposes will be voided.
                </li>
                <li>
                ...
                <li>
                  Recording is not permitted during the event. Audience members
                  accept that visual-audio recording devices may be confiscated
                  if deemed appropriate by the artist management.
                </li>
                <li>
                ...
                <li>
                  External food and drinks are not allowed in the concert area.
                </li>
                <li>
                  By participating in the event, attendees agree to grant the
                  Organizer the right to use photographs and videos taken during
